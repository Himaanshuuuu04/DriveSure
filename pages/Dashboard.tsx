  ...
  <div className="container mx-auto max-w-7xl px-6 py-8 flex flex-col gap-8 text-white animate-fade-in">
    <header className="flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-4">
        ...
        <div>
            ...
            <p className="text-gray-400">Manage your {title.toLowerCase()} settings and view details.</p>
        </div>
      </div>
    </header>
    ...
    <div className="flex-1 flex flex-col items-center justify-center rounded-3xl border border-white/5 bg-dashboard-surface/50 p-12 text-center min-h-[400px]">
        ...
        <p className="text-gray-400 max-w-md mx-auto leading-relaxed">
            We are currently building the <strong>{title}</strong> module. 
            Check back soon for updates on your telematics integration.
        </p>
    ...
    <div className="container mx-auto max-w-7xl px-6 py-8 flex flex-col gap-8 animate-fade-in">
      ...
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div className="flex flex-col gap-1">
          <h2 className="text-3xl font-extrabold tracking-tight text-white md:text-4xl">Welcome back, Alex</h2>
          <p className="text-base text-gray-400">Here is your live driving performance and wallet overview.</p>
        </div>
            ...
            <div className="absolute right-0 top-12 z-50 w-80 rounded-2xl border border-white/10 bg-dashboard-surface p-4 shadow-2xl backdrop-blur-xl">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex gap-3 rounded-xl bg-white/5 p-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-white">Reward Received</p>
                    <p className="text-xs text-gray-400">You earned 500 pts for safe driving.</p>
                  </div>
                </div>
                <div className="flex gap-3 rounded-xl bg-white/5 p-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-white">Trip Analysis</p>
                    <p className="text-xs text-gray-400">Your recent trip to downtown is ready.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="relative flex flex-col justify-between overflow-hidden rounded-2xl border border-white/5 bg-dashboard-surface p-6 shadow-sm group hover:border-white/10 transition-all">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-semibold text-gray-400">Driver Score</h3>
          ...
          <div className="relative mt-4 flex items-center justify-center py-4">
            ...
            <svg className="h-32 w-32 -rotate-90 transform" viewBox="0 0 100 100">
              <circle cx="50" cy="50" fill="transparent" r="40" stroke="#283932" strokeWidth="8"></circle>
              <circle cx="50" cy="50" fill="transparent" r="40" stroke="#11d483" strokeDasharray="251.2" strokeDashoffset="37.68" strokeLinecap="round" strokeWidth="8" className="transition-all duration-1000 ease-out"></circle>
            </svg>
          ...
          <div className="flex items-center justify-center gap-2 rounded-lg bg-green-500/10 px-3 py-2">
            ...
            <span className="text-sm font-medium text-primary">Top 15% of drivers</span>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between rounded-2xl border border-white/5 bg-dashboard-surface p-6 shadow-sm hover:border-white/10 transition-all">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-semibold text-gray-400">Wallet Balance</h3>
            <button className="text-xs font-medium text-primary hover:text-primary/80">View History</button>
          </div>
          <div className="mt-4 flex flex-col gap-1">
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-extrabold text-white transition-all duration-300">{balance.toLocaleString()}</span>
              <span className="text-sm font-bold text-primary">pts</span>
            </div>
            <p className="text-sm text-gray-500">≈ ₹{balance.toLocaleString()}.00 INR</p>
          </div>
        ...
        <div className="flex flex-col rounded-2xl border border-white/5 bg-dashboard-surface p-6 shadow-sm hover:border-white/10 transition-all">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-gray-400">Parametric Claims</h3>
            <div className="rounded-full bg-yellow-500/10 px-2 py-0.5 text-xs font-bold text-yellow-500 animate-pulse">Processing</div>
          </div>
          <div className="flex-1 flex flex-col justify-center gap-6 relative">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <p className="text-sm font-bold text-white">Accident Detected</p>
                <p className="text-xs text-gray-500">Sensors triggered - 10:42 AM</p>
              </div>
            </div>
            {/* Step 2 */}
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <p className="text-sm font-bold text-yellow-500">Verifying Data</p>
                <p className="text-xs text-gray-500">Oracle Validation in progress</p>
              </div>
            </div>
            {/* Step 3 */}
            <div className="relative flex items-center gap-4 opacity-50">
              <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full border-2 border-gray-600 bg-dashboard-surface">
              </div>
              <div className="flex flex-col">
                <p className="text-sm font-bold text-white">Smart Contract Payout</p>
                <p className="text-xs text-gray-500">Instant transfer to wallet</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="rounded-2xl border border-white/5 bg-dashboard-surface p-6 shadow-sm hover:border-white/10 transition-all">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div>
            <h3 className="text-lg font-bold text-white">Premium Burn Rate vs. Driving Habits</h3>
            <p className="text-sm text-gray-500">Analyze how your driving style impacts your point consumption.</p>
          </div>
          <div className="flex items-center gap-2 rounded-lg bg-white/5 p-1">
            {(['Weekly', 'Monthly', 'Yearly'] as const).map((range) => (
                <button 
                  ...
                  className={`rounded-md px-3 py-1 text-xs font-bold shadow-sm transition-all ${timeRange === range ? 'bg-white/10 text-white' : 'text-gray-500 hover:text-white'}`}
                >
                    {range}
                </button>
            ))}
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1 relative h-64 w-full">
            ...
            <svg className="h-full w-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 500 150">
              <defs>
                <linearGradient id="chartGradient" x1="0" x2="0" y1="0" y2="1">
                  <stop offset="0%" stopColor="#11d483" stopOpacity="0.3"></stop>
                  <stop offset="100%" stopColor="#11d483" stopOpacity="0"></stop>
                </linearGradient>
              </defs>
              {/* Grid Lines */}
              <line opacity="0.2" stroke="#334155" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="500" y1="150" y2="150"></line>
              <line opacity="0.2" stroke="#334155" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="500" y1="100" y2="100"></line>
              <line opacity="0.2" stroke="#334155" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="500" y1="50" y2="50"></line>
              <line opacity="0.2" stroke="#334155" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="500" y1="0" y2="0"></line>
              {/* Data Path */}
              <path 
            ...
            <div className="flex justify-between mt-2 text-xs font-medium text-gray-500">
               {timeRange === 'Weekly' && <><span>Week 1</span><span>Week 2</span><span>Week 3</span><span>Week 4</span></>}
               {timeRange === 'Monthly' && <><span>Jan</span><span>Apr</span><span>Aug</span><span>Dec</span></>}
               {timeRange === 'Yearly' && <><span>2023</span><span>2024</span><span>2025</span><span>2026</span></>}
            </div>
          </div>
          ...
          <div className="flex flex-row md:flex-col gap-4 min-w-[200px]">
            <div className="flex flex-col gap-1 rounded-xl bg-white/5 p-4 flex-1 hover:bg-white/10 transition-colors">
              <p className="text-xs text-gray-500 uppercase tracking-wider">Burn Rate</p>
              <p className="text-2xl font-bold text-white transition-all key={chartData[timeRange].burnRate}">{chartData[timeRange].burnRate}</p>
              <p className="text-xs font-medium text-primary">↓ Low Consumption</p>
            </div>
            <div className="flex flex-col gap-1 rounded-xl bg-white/5 p-4 flex-1 hover:bg-white/10 transition-colors">
              <p className="text-xs text-gray-500 uppercase tracking-wider">Projected Savings</p>
              <p className="text-2xl font-bold text-white transition-all key={chartData[timeRange].savings}">{chartData[timeRange].savings}</p>
              <p className="text-xs font-medium text-primary">↑ Better than average</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="group relative flex cursor-pointer flex-col gap-3 rounded-2xl border border-white/5 bg-dashboard-surface p-4 transition-all hover:border-primary/50 hover:bg-white/5">
            <div className="flex items-start justify-between">
              ...
              <span className="rounded-full bg-white/10 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-gray-400">NFT Badge</span>
            </div>
            <div>
              <h4 className="font-bold text-white group-hover:text-primary transition-colors">Eco-Warrior</h4>
              <p className="text-xs text-gray-500">Maintained low emissions for 30 days.</p>
            </div>
          </div>
          {/* Badge 2 */}
          <div className="group relative flex cursor-pointer flex-col gap-3 rounded-2xl border border-white/5 bg-dashboard-surface p-4 transition-all hover:border-blue-500/50 hover:bg-white/5">
            ...
            <div>
              <h4 className="font-bold text-white group-hover:text-blue-400 transition-colors">Safe Streak</h4>
              <p className="text-xs text-gray-500">100 miles without hard braking.</p>
            </div>
          </div>
          {/* Carbon Credits */}
          <div className="col-span-1 sm:col-span-2 relative overflow-hidden rounded-2xl border border-white/5 bg-dashboard-surface-highlight p-4 cursor-pointer hover:border-primary/30 transition-all">
            <div className="relative z-10 flex h-full flex-col justify-between gap-4">
              ...
              <div className="flex items-end gap-2">
                ...
                <span className="mb-1 text-sm font-medium text-gray-400">tons offset</span>
              </div>
    ...
    <div className="flex h-screen w-full overflow-hidden bg-dashboard-bg text-white font-display antialiased selection:bg-primary selection:text-dashboard-bg">
      ...
      <div className="hidden lg:flex w-72 flex-col justify-between border-r border-white/5 bg-dashboard-bg p-6">
        <div className="flex flex-col gap-8">
          {/* Brand */}
          <div className="flex items-center gap-3 cursor-pointer px-2" onClick={() => navigate('/')}>
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/20 text-primary">
              <span className="material-symbols-outlined text-2xl">shield</span>
            </div>
            <div className="flex flex-col">
              <h1 className="text-lg font-bold leading-none tracking-tight text-white">SphereInc</h1>
          ...
          <nav className="flex flex-col gap-6">
            ...
            >
              <span className={`material-symbols-outlined text-2xl ${isActive('/dashboard') ? 'text-primary' : 'text-gray-500 group-hover:text-primary transition-colors'}`}>dashboard</span>
              <span className={`font-bold text-lg ${isActive('/dashboard') ? 'text-white' : 'text-gray-400 group-hover:text-white transition-colors'}`}>Dashboard</span>
            </Link>

            {/* Other Menu Items */}
            <div className="flex flex-col gap-2 px-2">
                <Link to="/dashboard/stats" className={`group flex items-center gap-4 rounded-xl px-4 py-3 transition-all ${isActive('/dashboard/stats') ? 'bg-white/5' : 'hover:bg-white/5'}`}>
                    <span className={`material-symbols-outlined text-xl ${isActive('/dashboard/stats') ? 'text-primary' : 'text-gray-500 group-hover:text-white transition-colors'}`}>speed</span>
                    <span className={`font-medium ${isActive('/dashboard/stats') ? 'text-white' : 'text-gray-400 group-hover:text-white transition-colors'}`}>Drive Stats</span>
                </Link>

                <Link to="/dashboard/wallet" className={`group flex items-center gap-4 rounded-xl px-4 py-3 transition-all ${isActive('/dashboard/wallet') ? 'bg-white/5' : 'hover:bg-white/5'}`}>
                    <span className={`material-symbols-outlined text-xl ${isActive('/dashboard/wallet') ? 'text-primary' : 'text-gray-500 group-hover:text-white transition-colors'}`}>account_balance_wallet</span>
                    <span className={`font-medium ${isActive('/dashboard/wallet') ? 'text-white' : 'text-gray-400 group-hover:text-white transition-colors'}`}>Wallet</span>
                </Link>

                <Link to="/dashboard/marketplace" className={`group flex items-center gap-4 rounded-xl px-4 py-3 transition-all ${isActive('/dashboard/marketplace') ? 'bg-white/5' : 'hover:bg-white/5'}`}>
                    <span className={`material-symbols-outlined text-xl ${isActive('/dashboard/marketplace') ? 'text-primary' : 'text-gray-500 group-hover:text-white transition-colors'}`}>storefront</span>
                    <span className={`font-medium ${isActive('/dashboard/marketplace') ? 'text-white' : 'text-gray-400 group-hover:text-white transition-colors'}`}>Marketplace</span>
                </Link>

                <Link to="/dashboard/loans" className={`group flex items-center gap-4 rounded-xl px-4 py-3 transition-all ${isActive('/dashboard/loans') ? 'bg-white/5' : 'hover:bg-white/5'}`}>
                    <span className={`material-symbols-outlined text-xl ${isActive('/dashboard/loans') ? 'text-primary' : 'text-gray-500 group-hover:text-white transition-colors'}`}>credit_score</span>
                    <span className={`font-medium ${isActive('/dashboard/loans') ? 'text-white' : 'text-gray-400 group-hover:text-white transition-colors'}`}>Loans</span>
                </Link>
            </div>
          </nav>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <a className="group flex items-center gap-3 rounded-xl px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white transition-all" href="#">
          ...
          <div className="flex items-center gap-3 rounded-xl border border-white/5 bg-white/5 p-3">
            <div 
              ...
              style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAebQ323QIHos5jHBD-FxlO5y6vUDHPH8QF4MZ5YNbzzWAsOiXxJfjQS_YfqizTAGRo4S-5pYqFIOEBdZ-w-Ww9BBytjui4zbelzyRPgNga0LxLQGbjmdJTl6_5Fmif3uq9TtuQffrZoAIm59JLr6QZgwkvRLeRTSdiHiTU_Wi1lVoz9Hb5gy2yjCCRM4O36wEy8kuooibs91ZEYpqYI2vzQbNH2fVZDZR0cRdjQ8Fpv6QABJ2R2t3bO2cLXpE5PIVa8Atf_m1SIQ')" }}
            ></div>
      ...
      <main className="flex-1 flex flex-col h-full overflow-y-auto bg-dashboard-bg">
        <Routes>
            ...
            <Route path="/stats" element={<PlaceholderPage title="Drive Stats" icon="speed" />} />
            <Route path="/wallet" element={<PlaceholderPage title="Wallet" icon="account_balance_wallet" />} />
            <Route path="/marketplace" element={<PlaceholderPage title="Marketplace" icon="storefront" />} />
            <Route path="/loans" element={<PlaceholderPage title="Loans" icon="credit_score" />} />
        </Routes>
      </main>
    </div>
  );
