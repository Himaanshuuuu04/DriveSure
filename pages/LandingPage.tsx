          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-1 flex flex-col gap-6 lg:max-w-[600px] z-10">
              ...
              <p className="text-lg text-slate-400 leading-relaxed max-w-[540px]">
                Real-time telematics meets wallet-based premiums. Drive safer,
                stake rewards, and lower your costs instantly with our dynamic
                risk engine.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                <button
                  onClick={handleLogin}
                  className="h-12 px-8 rounded-lg bg-primary hover:bg-primary-dark text-landing-bg font-bold text-base transition-all neon-shadow flex items-center gap-2"
                >
        ...
        <div className="max-w-[1440px] mx-auto px-4 lg:px-10">
          <div className="flex flex-col gap-4 mb-16 max-w-[760px]">
            <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight">
              Wallet-Based Insurance
            </h2>
            <p className="text-lg text-slate-400">
              Seamless integration with your financial life. Top up, drive, and
              pay only for what you use. No annual contracts, just pure utility.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group p-8 rounded-2xl bg-landing-surface border border-white/5 hover:border-primary/50 transition-all hover:bg-landing-surface-highlight">
              ...
              <p className="text-slate-400 leading-relaxed">
                Link your crypto wallet (MetaMask, Phantom) or UPI for instant
                micro-transactions. Your keys, your coverage.
              </p>
            </div>
            {/* Feature 2 */}
            <div className="group p-8 rounded-2xl bg-landing-surface border border-white/5 hover:border-primary/50 transition-all hover:bg-landing-surface-highlight">
              ...
              <p className="text-slate-400 leading-relaxed">
                Our decentralized sensors track driving habits in real-time.
                Data is encrypted and stored on-chain for transparency.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="group p-8 rounded-2xl bg-landing-surface border border-white/5 hover:border-primary/50 transition-all hover:bg-landing-surface-highlight">
              ...
              <p className="text-slate-400 leading-relaxed">
                Premiums adjust dynamically based on your safety score. Stop
                driving? Your premium stops too.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-slate-400 mb-8 max-w-[500px]">
                Turn good habits into passive income. Stake your unused premium
                balance and earn yields. Collect NFT badges for milestones to
                unlock lower rates.
              </p>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-sm">
                      Earn up to 5% APY on your wallet balance for every
                      accident-free month.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-sm">
                      Unlock "Smooth Operator" or "Night Rider" badges that
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-sm">
                      Top drivers receive governance tokens to vote on protocol
                      upgrades.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex-1 w-full max-w-[500px]">
              <div className="bg-landing-surface-highlight border border-white/10 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
                ...
                <div className="space-y-3">
                  <h5 className="text-white text-sm font-bold mb-3">
                    Recent Badges
                  </h5>
      ...
      <div className="py-20 px-4">
        <div className="max-w-[1200px] mx-auto rounded-3xl bg-gradient-to-r from-landing-surface-highlight to-landing-surface border border-white/10 p-10 lg:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-lg text-slate-400 mb-10 max-w-[600px] mx-auto relative z-10">
            Join 25,000+ drivers saving money with SphereInc. Connect your
            wallet instantly and get covered in seconds.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
            <div className="col-span-2 lg:col-span-2">
              ...
              <p className="text-slate-500 text-sm max-w-[280px]">
                The world's first decentralized motor insurance protocol.
                Powered by Polygon. Secured by Chainlink.
              </p>
            </div>
            <div className="flex flex-col gap-4">
              <h4 className="text-white font-bold">Platform</h4>
              <a className="text-slate-500 hover:text-primary text-sm" href="#">
                Solutions
              </a>
              <a className="text-slate-500 hover:text-primary text-sm" href="#">
                Rewards
